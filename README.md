# US Federal Reserve Exchange Rate API — fed-exchange-rate
...
Also published under the org scope as [`@allratestoday/fed-exchange-rate`](https://www.npmjs.com/package/@allratestoday/fed-exchange-rate) — same code, same versions.
...
```javascript
{
  ...
  rate_date: '2026-08-07',   // US Federal Reserve's own publication date
  source: 'USD',
  target: 'JPY',
  rate: 157.54,
  rate_type: 'reference',
...
```javascript
{
  ...
  rates: [
    { "base": "USD", "quote": "JPY", "type": "reference", "value": 157.54 },
...
const series = await getHistory(
  { source: 'USD', target: 'JPY', from: '2026-01-01', to: '2026-08-07' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-08-07', rate: 157.54, rate_type: 'reference', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}

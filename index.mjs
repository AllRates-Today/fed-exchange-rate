// US Federal Reserve exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/fed';
...
/** Latest rate for one pair, e.g. getRate('USD', 'JPY', { apiKey }). */
